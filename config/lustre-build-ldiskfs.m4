...
#
AC_DEFUN([LB_SRC_EXT4_JOURNAL_GET_WRITE_ACCESS_4A], [
	LB2_LINUX_TEST_SRC([ext4_journal_get_write_access], [
		#include <linux/fs.h>
		#include "$EXT4_SRC_DIR/ext4.h"
		#include "$EXT4_SRC_DIR/ext4_jbd2.h"
...
AC_DEFUN([LB_EXT4_JOURNAL_GET_WRITE_ACCESS_4A], [
	LB2_MSG_LINUX_TEST_RESULT([if ext4_journal_get_write_access is available],
