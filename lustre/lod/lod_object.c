 ...
 * instantiated. It needs to be calculated in advance and taken into account at the
 * instantiation time, because otherwise lod_statfs_and_check() may consider an OST
 * as OK, but SEL needs its extension_size to fit the free space and the OST may turn
 * out to be low-on-space, thus inappropriate OST may be used and ENOSPC occurs.
 *
