		     ...
		     struct osd_device *o, struct lustre_cfg *cfg)
{
	...
	if (opts != NULL && strstr(opts, "force_over_128tb") != NULL) {
		CWARN("force_over_128tb option is deprecated. "
		      "Filesystems less than 1024TB can be created without any "
		      "force options. Use force_over_1024tb option for "
		      "filesystems greater than 1024TB.\n");
	}
#endif
	...
	if (opts != NULL && strstr(opts, "force_over_512tb") != NULL) {
		CWARN("force_over_512tb option is deprecated. "
		      "Filesystems less than 1024TB can be created without any "
		      "force options. Use force_over_1024tb option for "
		      "filesystems greater than 1024TB.\n");
	}
	...
	*options = '\0';
	...
	if (ldiskfs_blocks_count(LDISKFS_SB(osd_sb(o))->s_es) <<
		...
		CERROR("%s: device %s LDISKFS does not support filesystems "
		       "greater than 1024TB and can cause data corruption. "
		       "Use \"force_over_1024tb\" mount option to override.\n",
		       name, dev);
