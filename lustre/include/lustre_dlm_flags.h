...
#define LDLM_FL_WIRE_REQ_FLAGS_MASK					\
	(LDLM_FL_BLOCK_GRANTED		| LDLM_FL_BLOCK_WAIT		|\
	 ...
	 LDLM_FL_CANCEL_ON_BLOCK	| LDLM_FL_COS_INCOMPAT		|\
	 LDLM_FL_NO_EXPANSION		| LDLM_FL_DENY_ON_CONTENTION	|\
	 LDLM_FL_AST_DISCARD_DATA)

#define LDLM_FL_WIRE_REP_FLAGS_MASK					\
	(LDLM_FL_WIRE_REQ_FLAGS_MASK	| LDLM_FL_LOCK_CHANGED		|\
	 LDLM_FL_BLOCK_GRANTED		| LDLM_FL_AST_SENT		|\
	 LDLM_FL_DISCARD_DATA		| LDLM_FL_NO_TIMEOUT)
