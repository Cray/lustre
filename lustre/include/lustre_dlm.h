...
#define LDLM_DEFAULT_LRU_SLV_CHANGE (10)
...
struct ldlm_pool_ops {
	...
	int (*po_recalc)(struct ldlm_pool *pl, int force);
...
struct ldlm_pool {
	...
	/** Lock volume factor in percents. SLV on client is calculated as following:
	 *  server_slv * lock_volume_factor / 100. */
...
time64_t ldlm_bl_timeout_by_rpc(struct ptlrpc_request *req);
#endif
