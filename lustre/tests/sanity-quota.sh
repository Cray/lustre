...
test_1_check_write() {
	...
	# garantee that slave received new edquot trough glimpse.
...
test_7c() {
	...
	wait_ost_reint $QTYPE 240 || error "reintegration failed"
...
test_default_quota() {
	...
	$SETSTRIPE $TESTFILE -c 1 $qpool_cmd ||
...
test_76()
{
	...
	local TESTFILE00="$dir1/$tfile-00"
