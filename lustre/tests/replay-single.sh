...
test_70c() {
	...
	#define OBD_FAIL_PTLRPC_FAIL_CONNECT	   0x519
	# get $c1 eviction on recovery
	do_nodes $c1 "lctl set_param fail_loc=0x519"

	#define OBD_FAIL_PTLRPC_DELAY_CONNECT	 0x518
	# hold connection of $c3 for 5 seconds
	do_nodes $c3 "lctl set_param fail_loc=0x518"
