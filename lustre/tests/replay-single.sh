...
test_93() {
	...
	[[ $server_version -ge $(version_code 2.5.32) &&
	   $server_version -lt $(version_code 2.5.50) ]] ||
	[[ $server_version -ge $(version_code 2.5.4) &&
	   $server_version -lt $(version_code 2.5.11) ]] ||
	       { skip "Need MDS version 2.5.4+ or 2.5.33+ or 2.6.90+"; return; }
	...
	# not completing the recovery. Final ping is queued, but reply will
	# be sent on the recovery completion. It is done by sleep before
