...
test_12s() {
	...
	(( MDS1_VERSION >= $(version_code 2.15.0.3) )) ||
		skip "Need MDS version newer than 2.15.0.3"
...
test_410()
{
	[ "$MDS1_VERSION" -lt $(version_code 2.15.3.2) ] &&
		skip "need MDS version at least 2.15.4.2"

	[ "$CLIENT_VERSION" -lt $(version_code 2.15.3.2) ] &&
		skip "need client version at least 2.15.4.2"
...
test_607a()
{
	...
	(( MDS1_VERSION >= $(version_code 2.15.4.2) )) ||
		skip "need MDS version at least 2.15.4.2"
