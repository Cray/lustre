...
test_115a() {
	helper_test_115 "-i" "1048576"
}
run_test 115a "HSM migrate test with -i, stripe size of 1MiB"

test_115b() {
	helper_test_115 "-i" "2097152"
}
run_test 115b "HSM migrate test with -o, stripe size of 2MiB"

test_115c() {
	helper_test_115 "-o" "4194304"
}
run_test 115c "HSM migrate test with -o, stripe size of 4MiB"

test_115d() {
	helper_test_115 "-o" "65536"
}
run_test 115d "HSM migrate test with -o, stripe size of 64KiB"
