...
test_43j() {
	[[ $MDS1_VERSION -lt $(version_code 2.12.7) ]] &&
		skip "Need MDS version newer than 2.12.7"
...
run_test 106 "rename to an open file and link race should not cause fs corruption"
...
test_109() {
	...
	do_facet mds1 lctl set_param fail_loc=0x525
...
run_test 109 "do not grant another lock on resend"
