...
ALWAYS_EXCEPT="14b     21b     24 25       $REPLAY_DUAL_EXCEPT"
...
test_19() { # Bug 10991 - resend of open request does not fail assertion.
    replay_barrier $SINGLEMDS
    drop_mds_ldlm_reply "createmany -o $DIR/$tfile 1" || return 1
    fail $SINGLEMDS
...
test_31() {
	...
	DIRSTRIPE_INDEX=0 consume_precreations $DIR1/$tdir mds1 0 1
