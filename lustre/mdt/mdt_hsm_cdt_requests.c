...
static unsigned int
cdt_request_cookie_hash(cfs_hash_t *hs, const void *key, unsigned int mask)
{
...
static void cdt_request_cookie_get(cfs_hash_t *hs, struct hlist_node *hnode)
{
	struct cdt_agent_req *car = cdt_request_cookie_object(hnode);
...
static void cdt_request_cookie_put(cfs_hash_t *hs, struct hlist_node *hnode)
{
	struct cdt_agent_req *car = cdt_request_cookie_object(hnode);
...
cfs_hash_ops_t cdt_request_cookie_hash_ops = {
